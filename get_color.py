...
def test(conf_path, process_mode):
    ...
    for p in image_paths:
        ...
        with open(r'./0107/dir_{}_rgb.json'.format(tmp1), 'w') as js_file:
            js_file.write(data)
...
def get_lab(LAB_OK=True):
    bad_rgb_lab_pair = ['2_17', '2_13', '7_6', '6_15', '9_8', '3_7', '12_10', '12_20', '15_3', '15_7', '1_1', '1_14', '2_8', '2_9', '3_14', '3_6', '5_4', '5_12', '5_16', '5_8', '8_9', '8_16', '8_4', '10_20', '10_19', '4_3', '4_20', '14_1', '11_5', '14_15'
, '14_16']
    # green data, g < b
    bad_green = []
    L = [9.5, 14.5]
    ...
    for ind in inds:
        ...
        for k, v in js.items():
            if LAB_OK:
                if (k not in test_ims) and (k not in yc) and (k not in bad_rgb_lab_pair) and (k not in bad_green):
                    all_trian_rgb[k] = v
